...
<div class="ui grid">
    <div class="sixteen wide column">
      ...
      <form action="<?php echo base_url('main/weeklyReport'); ?>" method="post">
        <div class="ui input">
          From: <input type="text" placeholder="Filter by date" id="datepicker" name="from" value="<?php echo $from; ?>">
        </div>
        <div class="ui input">
          To: <input type="text" placeholder="Filter by date" id="datepicker1" name="to" value="<?php echo $to; ?>">
        </div>
...
<br/>
    <a href="<?php echo base_url('main/excel').'/'.$from.'/'.$to;?>" class="ui blue button">
      <i class="plus icon"></i> Export to Excel
    </a>
    </div>
</div>
